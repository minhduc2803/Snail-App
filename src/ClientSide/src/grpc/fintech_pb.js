...
goog.exportSymbol('proto.fintech.TransferResponse.Data.IsSuccessful', null, global);
/**
...
proto.fintech.TransferResponse.Data.toObject = function(includeInstance, msg) {
  var f, obj = {
    issuccessful: jspb.Message.getFieldWithDefault(msg, 1, 0)
  };
...
proto.fintech.TransferResponse.Data.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.fintech.TransferResponse.Data.IsSuccessful} */ (reader.readEnum());
 ...
 * @enum {number}
 */
proto.fintech.TransferResponse.Data.IsSuccessful = {
  TRUE: 0,
  FALSE: 1
};

/**
 * optional IsSuccessful isSuccessful = 1;
 * @return {!proto.fintech.TransferResponse.Data.IsSuccessful}
 */
proto.fintech.TransferResponse.Data.prototype.getIssuccessful = function() {
  return /** @type {!proto.fintech.TransferResponse.Data.IsSuccessful} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/**
 * @param {!proto.fintech.TransferResponse.Data.IsSuccessful} value
 * @return {!proto.fintech.TransferResponse.Data} returns this
 */
proto.fintech.TransferResponse.Data.prototype.setIssuccessful = function(value) {
  return jspb.Message.setProto3EnumField(this, 1, value);
};
