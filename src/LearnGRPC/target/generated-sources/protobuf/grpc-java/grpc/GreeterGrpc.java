...
public final class GreeterGrpc {
  ...
  public static abstract class GreeterVertxImplBase implements io.grpc.BindableService {
     ...
     */
    public void sayHello(grpc.HelloRequest request,
        io.vertx.core.Future<grpc.HelloReply> response) {
  ...
  public static final class GreeterVertxStub extends io.grpc.stub.AbstractStub<GreeterVertxStub> {
     ...
     */
    public void sayHello(grpc.HelloRequest request,
        io.vertx.core.Handler<io.vertx.core.AsyncResult<grpc.HelloReply>> response) {
      asyncUnaryCall(
  ...
  private static final class VertxMethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((grpc.HelloRequest) request,
              (io.vertx.core.Future<grpc.HelloReply>) io.vertx.core.Future.<grpc.HelloReply>future().setHandler(ar -> {
                if (ar.succeeded()) {
                  ((io.grpc.stub.StreamObserver<grpc.HelloReply>) responseObserver).onNext(ar.result());
