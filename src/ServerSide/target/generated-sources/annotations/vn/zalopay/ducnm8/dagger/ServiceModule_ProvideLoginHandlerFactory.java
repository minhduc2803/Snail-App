...
public final class ServiceModule_ProvideLoginHandlerFactory implements Factory<LoginHandler> {
  ...
  public LoginHandler get() {
    return provideLoginHandler(module, accountDAProvider.get(), transactionProvider.get(), userCacheProvider.get(), jwtAuthProvider.get());
  }

  public static ServiceModule_ProvideLoginHandlerFactory create(ServiceModule module,
      Provider<AccountDA> accountDAProvider, Provider<TransactionProvider> transactionProvider,
      Provider<UserCache> userCacheProvider, Provider<JWTAuth> jwtAuthProvider) {
    return new ServiceModule_ProvideLoginHandlerFactory(module, accountDAProvider, transactionProvider, userCacheProvider, jwtAuthProvider);
  }
  ...
  public static LoginHandler provideLoginHandler(ServiceModule instance, AccountDA accountDA,
    ...
    return Preconditions.checkNotNull(instance.provideLoginHandler(accountDA, transactionProvider, userCache, jwtAuth), "Cannot return null from a non-@Nullable @Provides method");
  }
}
